...
public class CustomerController {
    ...
    @GetMapping
    public ModelAndView list(@PageableDefault(value = 1) Pageable pageable) throws Exception {
    ...
    @GetMapping("/edit/{id}")
    public ModelAndView toForm(@PathVariable("id") Long id) throws Exception {
    ...
    public String delete(@PathVariable("id") Long id, RedirectAttributes redirect) throws Exception {
        Optional<Customer> customer = customerService.findById(id);
        if (customer.isPresent()) {
    ...
    @GetMapping("/search")
    public ModelAndView list(@RequestParam("search") Optional<String> search, @PageableDefault(value = 1) Pageable pageable) throws Exception {
