    ...
    <div class="container">
        <div class="header">
            <div class="logo-and-search">
                <div class="logo">
                    <a href="${pageContext.request.contextPath}/product?username=${username}">
            ...
            <table class="table">
                ...
                <c:forEach items="${products}" var="product">
                    <tr>
                        ...
                        <td>
                            <a class="view" href="${pageContext.request.contextPath}/product?action=view&username=${username}&id=${product.getId()}">
                        ...
                        <td><button type="button" onclick="openEditModal('${product.getId()}', '${product.getName()}', '${product.getPrice()}', '${product.getDescription()}', '${product.getBrand().getId()}')"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="${pageContext.request.contextPath}/product?username=${username}&action=create" method="post">
                        ...
                        <input id="c-price" type="text" name="price" class="form-control mb-2" placeholder="Enter price:">
                        <input id="c-description" type="text" name="description" class="form-control mb-2" placeholder="Enter description:">
                        <select id="c-brand" class="form-select" name="brand" aria-label="Default select example">
                            <option value="">-- Choose brand --</option>
                            <c:forEach items="${brands}" var="brand">
                                <option value="${brand.getId()}"><c:out value="${brand.getName()}"/></option>
                            </c:forEach>
                        </select>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="${pageContext.request.contextPath}/product?username=${username}&action=edit" method="post">
                        ...
                        <input id="e-price" type="text" name="price" class="form-control mb-2" placeholder="Enter price:">
                        <input id="e-description" type="text" name="description" class="form-control mb-2" placeholder="Enter description:">
                        <select id="e-brand" class="form-select" name="brand" aria-label="Default select example">
                            <option value="">-- Choose brand --</option>
                            <c:forEach items="${brands}" var="brand">
                                <option class="focus" id="focus-${brand.getId()}" value="${brand.getId()}"><c:out value="${brand.getName()}"/></option>
                            </c:forEach>
                        </select>
                        <div class="submit mt-3">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
